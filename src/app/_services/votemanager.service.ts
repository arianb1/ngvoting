...
import { Vote, VoteOption } from '../_models';
const Web3 = require('web3');
declare let require: any;
declare let window: any;
// tokenAbi points to the ABI file we compiled from the contract SOL file
const tokenAbi = '[{"inputs":[{"internalType":"address","name":"contractVoteAddress","type":"address"},{"internalType":"address","name":"voter","type":"address"},{"internalType":"bytes32","name":"propsalName","type":"bytes32"}],"name":"castVote","outputs":[{"internalType":"string","name":"","type":"string"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"string","name":"votename","type":"string"},{"internalType":"string","name":"vodedesc","type":"string"},{"internalType":"bytes32[]","name":"options","type":"bytes32[]"}],"name":"createNewVote","outputs":[{"internalType":"address","name":"newContract","type":"address"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"stateMutability":"nonpayable","type":"constructor"},{"anonymous":false,"inputs":[{"indexed":false,"internalType":"address","name":"contractAddress","type":"address"}],"name":"newVoteContractCreated","type":"event"},{"inputs":[{"internalType":"address","name":"contractVoteAddress","type":"address"},{"internalType":"string","name":"vn","type":"string"},{"internalType":"string","name":"vd","type":"string"},{"internalType":"bytes32[]","name":"proposalNames","type":"bytes32[]"}],"name":"updateVoteByAddress","outputs":[{"internalType":"string","name":"","type":"string"}],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"getContractCount","outputs":[{"internalType":"uint256","name":"contractCount","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"getDeployedChildVotes","outputs":[{"components":[{"internalType":"string","name":"voteName","type":"string"},{"internalType":"address","name":"voteAddress","type":"address"},{"internalType":"address","name":"voteCreator","type":"address"},{"internalType":"string","name":"voteStatus","type":"string"}],"internalType":"struct VoteManager.VoteInfo[]","name":"","type":"tuple[]"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"pos","type":"uint256"}],"name":"getVoteAddressByPosition","outputs":[{"internalType":"address","name":"contractVoteAddress","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"contractVoteAddress","type":"address"}],"name":"getVoteByAddress","outputs":[{"internalType":"string","name":"","type":"string"},{"internalType":"string","name":"","type":"string"},{"components":[{"internalType":"bytes32","name":"name","type":"bytes32"},{"internalType":"uint256","name":"voteCount","type":"uint256"}],"internalType":"struct Vote.Proposal[]","name":"","type":"tuple[]"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"lastContractAddress","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"","type":"uint256"}],"name":"voteList","outputs":[{"internalType":"string","name":"voteName","type":"string"},{"internalType":"address","name":"voteAddress","type":"address"},{"internalType":"address","name":"voteCreator","type":"address"},{"internalType":"string","name":"voteStatus","type":"string"}],"stateMutability":"view","type":"function"}]';
const address = '0x7499B38744aFe5d9Fa060EA4562959C5aa896bc4';
...
export class VotesManagerService {
  ...
  public async createVote(vn: string, vd: string, proposalNames: Array<VoteOption>): Promise<any> {
    const that = this;
    ...
    const params: string[] = [];
    for (const entry of proposalNames) {
      params.push(window.web3.utils.toHex(entry.optionName.trim()));
    }
  ...
  public async retreiveVote(contractVoteAddress): Promise<Vote> {
    const that = this;
    ...
    const vte = new Vote();
    vte.voteTitle = result1[0];
    vte.voteDesc = result1[1];
    vte.totalVoteCount = 0;
    for (const entry of result1[2]) {
      const voteOpt = new VoteOption();
      voteOpt.optionName = window.web3.utils.hexToAscii(entry[0]).replace(/[^\x20-\x7E]/g, '');
      voteOpt.voteCount =  entry[1];
      vte.voteOptions.push(voteOpt);
      vte.totalVoteCount = vte.totalVoteCount + voteOpt.voteCount;
    }
    // result1[2] = result1[2].map(x => window.web3.utils.hexToAscii(x).replace(/[^\x20-\x7E]/g, ''));
    return Promise.resolve(vte);
  }

  public async updateVote(contractVoteAddress: any, vn: string, vd: string, proposalNames: Array<VoteOption>): Promise<any> {
    const that = this;
